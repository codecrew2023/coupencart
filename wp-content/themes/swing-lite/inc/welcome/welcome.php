	...
	class Swing_Lite_Welcome {
			...
			public function __construct( $plugins, $strings ) {
				...
				$this->tab_sections = array(
					...
					'actions_required' => esc_html__('Recommended Plugins', 'swing-lite'),
							...
							<div class="apwelcome-column col-demos">
								...
								<div>
									<div class="button-wrapper">
										...
										<?php printf( wp_kses_post( '<a class="options-page-btn notice-info-btn button-secondary" href="%2$s">Or start setting up your theme now (without demo)!</a>', 'swing-lite' ), $this->theme_name, esc_url(admin_url( 'themes.php?page=welcome-page' ))  ); ?>
