...
class Woo_Category_Slider_Review {
	...
	public function woo_product_slider_install_admin_notice() {
		...
		if ( current_user_can( 'install_plugins' ) && 'sp_wcslider' === $the_current_post_type ) {
			...
			echo sprintf( '<div class="wps-notice notice is-dismissible"><img src="%1$s"/><div class="wps-notice-text">To Create <strong>Interactive Product Sliders</strong> in your Shop to <strong>Boost Sales</strong>, %4$s the <a href="%2$s" class="thickbox open-plugin-details-modal"><strong>Product Slider for WooCommerce</strong></a> <a href="%3$s" rel="noopener" class="wps-activate-btn">%5$s</a><a href="https://shapedplugin.com/woocommerce-product-slider/lite-version-demo/" target="_blank" class="wps-demo-button">See How It Works<span>%6$s</span></a></div></div>', esc_url( $icon ), esc_url( $popup_url ), esc_url( $install_url ), esc_html( $text ), esc_html( $button_text ), $arrow );
		}
	...
	public function smart_brand_install_admin_notice() {
		...
		if ( current_user_can( 'install_plugins' ) && 'sp_wcslider' === $the_current_post_type ) {
			...
			echo sprintf( '<div class="wsb-notice notice is-dismissible"><img src="%1$s"/><div class="wsb-notice-text">To <strong>Add Brands</strong> and <strong>Highlight the Brands of the Products</strong> you sell, %4$s the <a href="%2$s" class="thickbox open-plugin-details-modal"><strong>Smart Brands for WooCommerce</strong></a> <a href="%3$s" rel="noopener" class="wsb-activate-btn">%5$s</a><a href="https://demo.shapedplugin.com/smart-brands-for-woocommerce/" target="_blank" class="wsb-demo-button">See How It Works<span>%6$s</span></a></div></div>', esc_url( $icon ), esc_url( $popup_url ), esc_url( $install_url ), esc_html( $text ), esc_html( $button_text ), $arrow );
		}
